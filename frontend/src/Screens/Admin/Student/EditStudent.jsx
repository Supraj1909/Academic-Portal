...
const EditStudent = () => {
  ...
  return (
    <div className="my-6 mx-auto w-full">
      <form
        className="flex justify-center items-center border-2 border-black rounded w-[40%] mx-auto"
      ...
      {search && id && (
        ...
        >
          ...
          <button
            type="submit"
            className="bg-black px-6 py-3 rounded-sm mb-6 text-white hover:bg-blue-50 hover:text-black"
          >
            Update Student
          </button>
        </form>
