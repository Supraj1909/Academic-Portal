    ...
    <div className="w-full mx-auto flex justify-center items-start flex-col my-10">
      ...
      {!studentData && (
        <>
          ...
          <button
            className="bg-blue-50 px-4 py-2 mt-8 mx-auto rounded border-2 border-black text-black"
            ...
            {studentData.map((student) => {
              return (
                <div
                  ...
                  className="w-[30%] flex justify-between items-center border-2 border-black rounded"
