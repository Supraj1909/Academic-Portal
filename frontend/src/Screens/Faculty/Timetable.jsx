    ...
    <div className="w-full mx-auto mt-10 flex justify-center items-start flex-col mb-10">
      ...
      <div className="w-full flex justify-evenly items-center mt-12">
        <div className="w-1/2 flex flex-col justify-center items-center">
          ...
          {previewUrl && (
            <p
              className="px-2 border-2 border-black py-2 rounded text-base w-[80%] mt-4 flex justify-center items-center cursor-pointer"
              onClick={() => {
                setFile("");
                setPreviewUrl("");
              }}
          ...
          />
          <button
            className="bg-black text-white mt-8 px-4 py-2 rounded-sm"
