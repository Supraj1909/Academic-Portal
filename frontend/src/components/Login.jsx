...
const Login = () => {
  ...
  .catch((error) => {
    console.error("Login Error: ", error);  // Log the error to see the issue
    toast.dismiss();
  ...
  return (
    <div className="bg-white h-[100vh] w-full flex justify-between items-center">
      <img
        ...
        src="https://www.iiml.ac.in/sites/default/files/MBAEI/mba/admission_mba_ei.JPG"
        alt=""
      />
      <div className="w-[40%] flex justify-center items-start flex-col pl-8">
        <p className="text-3xl font-semibold pb-2 border-b-2 border-black">
        ...
        >
          ...
          <button className="bg-black mt-5 text-white px-6 py-2 text-xl rounded-md hover:bg-blue-700 ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all flex justify-center items-center">
            Login
            <span className="ml-2">
              <FiLogIn />
            </span>
      ...
      <div className="absolute top-4 right-4">
        <button
          className={`text-black mr-6 text-base font-semibold hover:text-blue-700 ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all ${
            selected === "Student" && "border-b-2 border-black"
          }`}
        ...
        <button
          className={`text-black mr-6 text-base font-semibold hover:text-blue-700 ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all ${
            selected === "Faculty" && "border-b-2 border-black"
          }`}
        ...
        <button
          className={`text-black mr-6 text-base font-semibold hover:text-blue-700 ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all ${
            selected === "Admin" && "border-b-2 border-black"
          }`}
